  ...
  return (
    ...
    >
      ...
      <div className="modal-content bg-white">
        ...
        <h1 id="modal-title">Order Confirmed</h1>
        <p id="modal-description">We hope you enjoy your food</p>
        <div className="modal-cart ">
          {cart.get().map((item) => (
            <div
              className="cart-card flex justify-between items-center"
              key={item.id}
            >
              ...
              <p className="font-semibold">${getEachTotal(item)}</p>
            </div>
          ))}
          <div
